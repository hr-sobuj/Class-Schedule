...
public class developer extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.backId){
            Intent intent=new Intent(developer.this,new_app_menu.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.nvtodayclassschedules:
                ...
                Intent intent1=new Intent(developer.this,classactivity.class);
            ...
            case R.id.nvnoticeboardid:
                ...
                Intent intent2=new Intent(developer.this,notice_display_activity.class);
            ...
            case R.id.nvcurriculamid:
                Intent intent3=new Intent(developer.this,curriculamactivity.class);
            ...
            case R.id.nvbusscheduleid:
                Intent intent4=new Intent(developer.this,busschedulepdf.class);
            ...
            case R.id.nvfacebookgrpid:
                Intent intent5=new Intent(developer.this,facebook_group.class);
            ...
            case R.id.nvsettimeid:
                ...
                Intent intent6=new Intent(developer.this,settimeactivity.class);
            ...
            case R.id.nvdeveloperid:
                Intent intent9=new Intent(developer.this,developer.class);
            ...
            case R.id.nvaboutthisappid:
                ...
                try{
                    ...
                    Intent intent10=new Intent(developer.this,AboutThisApplication.class);
                    startActivity(intent10);

                }catch (Exception e){
                    Toast.makeText(developer.this,"Exception"+e,Toast.LENGTH_LONG).show();
                }
