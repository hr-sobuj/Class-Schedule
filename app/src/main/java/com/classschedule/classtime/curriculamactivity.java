...
public class curriculamactivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    PDFView curriculampdf;
    private DrawerLayout mNavDrawer;
    Button btnaYes,btnaNo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.nav_curridulum);
        ...
        curriculampdf = (PDFView) findViewById(R.id.pdfViewcurriculum);

        curriculampdf.fromAsset("csecurriculam.pdf").load();

  /*  pdfc=(PDFView) findViewById(R.id.cpdf);
        pdfc.fromAsset("busschedule.pdf").load();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.backId){
            Intent intent=new Intent(curriculamactivity.this,new_app_menu.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.nvtodayclassschedules:
                ...
                Intent intent1=new Intent(curriculamactivity.this,classactivity.class);
            ...
            case R.id.nvnoticeboardid:
                ...
                Intent intent2=new Intent(curriculamactivity.this,notice_display_activity.class);
            ...
            case R.id.nvcurriculamid:
                Intent intent3=new Intent(curriculamactivity.this,curriculamactivity.class);
            ...
            case R.id.nvbusscheduleid:
                Intent intent4=new Intent(curriculamactivity.this,busschedulepdf.class);
            ...
            case R.id.nvfacebookgrpid:
                Intent intent5=new Intent(curriculamactivity.this,facebook_group.class);
            ...
            case R.id.nvsettimeid:
                ...
                Intent intent6=new Intent(curriculamactivity.this,settimeactivity.class);
            ...
            case R.id.nvdeveloperid:
                Intent intent9=new Intent(curriculamactivity.this,developer.class);
            ...
            case R.id.nvaboutthisappid:
                ...
                try{
                    ...
                    Intent intent10=new Intent(curriculamactivity.this,AboutThisApplication.class);
                    startActivity(intent10);

                }catch (Exception e){
                    Toast.makeText(curriculamactivity.this,"Exception"+e,Toast.LENGTH_LONG).show();
                }
