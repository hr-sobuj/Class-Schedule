...
public class busschedulepdf extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nav_busschedule);

        buspdfV =(PDFView) findViewById(R.id.pdfViewbus);

        buspdfV.fromAsset("busschedule.pdf").load();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.backId){
            Intent intent=new Intent(busschedulepdf.this,new_app_menu.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.nvtodayclassschedules:
                ...
                Intent intent1=new Intent(busschedulepdf.this,classactivity.class);
            ...
            case R.id.nvnoticeboardid:
                ...
                Intent intent2=new Intent(busschedulepdf.this,notice_display_activity.class);
            ...
            case R.id.nvcurriculamid:
                Intent intent3=new Intent(busschedulepdf.this,curriculamactivity.class);
            ...
            case R.id.nvbusscheduleid:
                Intent intent4=new Intent(busschedulepdf.this,busschedulepdf.class);
            ...
            case R.id.nvfacebookgrpid:
                Intent intent5=new Intent(busschedulepdf.this,facebook_group.class);
            ...
            case R.id.nvsettimeid:
                ...
                Intent intent6=new Intent(busschedulepdf.this,settimeactivity.class);
            ...
            case R.id.nvdeveloperid:
                Intent intent9=new Intent(busschedulepdf.this,developer.class);
            ...
            case R.id.nvaboutthisappid:
                ...
                try{
                    ...
                    Intent intent10=new Intent(busschedulepdf.this,AboutThisApplication.class);
                    startActivity(intent10);

                }catch (Exception e){
                    Toast.makeText(busschedulepdf.this,"Exception"+e,Toast.LENGTH_LONG).show();
                }
